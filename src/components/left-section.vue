    ...
    <div class="flex flex-col gap-4 my-auto mx-auto">
      <card title="Yuriy Ivanskyi">
        <div class="flex flex-col gap-1 justify-left px-4">
          ...
          <p class="text-sm text-left mx-0 font-normal text-gray-500">Fun facts:</p>
          <p
      ...
      <card title="Skills">
        <div class="flex flex-col gap-1 justify-center px-4">
          <p class="text-base text-left mx-0 font-normal text-gray-500">List of thingies I can/know/do:</p>
          <p v-for="line in skills"
            class="text-sm text-left ml-4 font-normal text-gray-500"> - {{ line }}</p>
          <p class="text-base text-left mx-0 font-normal text-gray-500">List of goodies I can/know/use:</p>
