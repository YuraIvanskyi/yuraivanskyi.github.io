...
<template>
    <li class="mb-10 ml-6 text-left">
        ...
        <h3 class="flex items-center mb-1 text-lg text-gray-900">
            {{ title }}
            <span
                v-if="present"
                class="bg-rose-600 text-white text-sm font-medium mr-2 px-2.5 py-0.5 rounded ml-3"
            >Present</span>
        </h3>
        <time class="block mb-2 text-sm font-normal text-gray-500">{{ company }}</time>
